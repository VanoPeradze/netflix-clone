...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed z-40">
      <div className={`px-4 md:px-16 py-6 flex flex-row items-center transition duration-500 ${showBackground ? 'bg-gradient-to-r from-zinc-400 to-white-400 opacity-90' : ''}`}>
